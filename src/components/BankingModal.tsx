...
export const BankingModal: React.FC<BankingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-2 sm:p-4 overflow-y-auto select-none">
      <div className="bg-white rounded-xl shadow-2xl border-4 border-purple-700 w-full max-w-2xl max-h-[92vh] overflow-hidden flex flex-col animate-scale-in my-auto">
        {/* Header */}
